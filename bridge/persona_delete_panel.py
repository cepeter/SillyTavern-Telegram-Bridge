...
def send_persona_delete_menu(token: str, chat_id: str, current_persona: str, message_id: int | None = None, page: int = 0, *, persona_service: PersonaService, request_context) -> None:
    ...
    rows = [[{"text": "🗑️ " + label, "callback_data": "persona:delete:" + dynamic_callback_token("persona", persona_id, chat_id, db=request_context.db)}] for persona_id, label in page_options]
