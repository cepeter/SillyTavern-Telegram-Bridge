...
def send_expression_menu(token: str, chat_id: str, session: dict, db: sqlite3.Connection, message_id: int | None = None, page: int = 0, *, delivery_port: DeliveryPort, request_context) -> None:
